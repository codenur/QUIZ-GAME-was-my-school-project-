...
mycon=mysql.connector.connect(user='root',password='',host='localhost',charset='utf8')
...
#PROCEDURE FOR LOGIN   
    ...
    if(ch==5):
        print("FOUNDER & PROGRAMMERS : NUR HASSAN MAZUMDAR")
        print("CO-FOUNDER & CFO      : GAURAV KUMAR")
